...
export const CreateCategory = () => {
    ...
    return (
        <>
            <div className='container-fluid' style={{hieght:"50vh"}}>
                <div className='row'>
                    ...
                    <div className='col-md mt-5'>
                        <div className='container'>
                            <div className='d-flex justify-content-between'>
                                <div className='fs-4 fw-bold'>Create Category</div>
                            </div>

                            <div className='row'>
                                <div className='col-md-5 mx-auto'>
                                    <div className="d-flex justify-content-center my-5">
                                        <input type="text" className="border border-secondary border-opacity-25 px-2 w-100 mx-auto input-field" onChange={(e) => setCategory(e.target.value)} placeholder="Enter your Category" />
