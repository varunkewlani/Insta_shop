    ...
    <>
      ...
      <div className="collapse navbar-collapse" id="navbarNavDropside">
        <div className="d-flex flex-column flex-shrink-0 p-3 bg-white">
          <Link to="/" className=" align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
          ...
          <ul className="nav nav-pills flex-column mb-auto my-2">
            ...
            <li><Link to="/createproducts" className="nav-link my-1 text-dark fs-6 px-3 ms-1 admin-nav-items">Product</Link></li>
          </ul>
        </div>
      </div>
